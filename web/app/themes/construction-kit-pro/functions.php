...
function construction_kit_setup() {
	...
	$gallery_zoom = construction_kit_get_option( 'enable_gallery_zoom' );
...
function construction_kit_scripts() {
	...
	wp_enqueue_script( 'construction-kit-custom', get_template_directory_uri() . '/assets/js/custom.js', array( 'jquery' ), '1.0.3', true );
