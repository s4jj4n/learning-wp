...
$config = array(
	...
	'quick_links' => array(
		'theme_url' => array(
			...
			'url'  => 'https://wpcharms.com/item/construction-kit-pro/',
			),
		'demo_url' => array(
	...
	'getting_started' => array(
		...
		array(
			...
			'button_link'         => esc_url( admin_url( 'themes.php?page=construction-kit-pro-about&tab=recommended_actions' ) ),
			'is_button'           => false,
			'recommended_actions' => false,
			'is_new_tab'          => false,
		),
		...
		array(
			...
			'button_link'  			=> esc_url( 'https://wpcharms.com/support/item/construction-kit-pro/' ),
			'is_button'    			=> false,
			'recommended_actions' 	=> false,
			'is_new_tab'   			=> true,
		),
