...
if ( ! class_exists( 'Construction_Kit_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Construction_Kit_Demo {

		/**
		 * Singleton instance of Construction_Kit_Demo.
		 *
		 * @var Construction_Kit_Demo $instance Construction_Kit_Demo instance.
		 */
		...
		/**
		 * Main Construction_Kit_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Construction_Kit_Demo ) ) {
				self::$instance = new Construction_Kit_Demo();
