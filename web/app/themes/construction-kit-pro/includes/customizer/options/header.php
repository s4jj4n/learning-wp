...
$wp_customize->add_setting( 'theme_options[enable_sticky_header]',
	array(
		'default'           => $default['enable_sticky_header'],
		'sanitize_callback' => 'construction_kit_sanitize_checkbox',
	)
);
$wp_customize->add_control( 'theme_options[enable_sticky_header]',
	array(
		'label'    			=> esc_html__( 'Enable Sticky Header', 'construction-kit' ),
